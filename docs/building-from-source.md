...
(`basharahmad/lakehouse-*:1.0.0`), so **you do not need to build anything to run
...
```
services/surface/target/surface-1.0.0.jar
services/ingestion-service/target/ingestion-service-1.0.0.jar
services/query-service/target/query-service-1.0.0.jar
services/graph-service/target/graph-service-1.0.0.jar
services/inference-service/target/inference-service-1.0.0.jar
```
